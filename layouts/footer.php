      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
            ...
            <a href="#" class="block-6">
              ...
              <h3 class="font-weight-light  mb-0">Encuentra tu planta perfecta</h3>
              <p>Promoción del 15 de enero &mdash; 25, 2021</p>
            </a>
          </div>
          <div class="col-md-6 col-lg-3">
            <div class="block-5 mb-5">
              ...
              <ul class="list-unstyled">
                <li class="address">San Bernardo, Cundinamarca.</li>
                <li class="phone"><a href="tel://23923929210">+57 3142750829</a></li>
                <li class="email">florecer@gmail.com</li>
              </ul>
            </div>
        ...
        <div class="row pt-5 mt-5 text-center">
          <div class="col-md-12">
            ...
            Florecer <i class="icon-heart" aria-hidden="true"></i>
